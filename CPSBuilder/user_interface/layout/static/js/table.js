// Not used
// For filtering in the search bar
...
document.querySelector('#filter_input').addEventListener('keyup', filterTable, false);

// Different way of getting the query because the specific id is needed to get passed through
...
function more_details(index, el) {
