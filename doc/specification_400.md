...
# Code 400
This sheet refers to use cases that is associated with processes running in the background/offline on the CPS Builder.
...
## UC-40000: Generate availability probability
Priority: Desired  
Use frequency: Always  
Success scenario: STEP(S)  
Notes and Questions:  
![context-avail_p-generation](assets/dfd_context-avail_p-generation.png)  
